const config_data = {
    /* Add emails to be notified here */
    "emails": [
        "roydey10@gmail.com"
    ],
    /* Add URLs you want the bot to keep track of here. Only Newegg supported. */
    "urls": [
    ...
    /* Set the amount of time in minutes the bot waits before rechecking the stock status*/
    "interval": 1
}
